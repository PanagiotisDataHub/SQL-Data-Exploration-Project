/*
Question: What are the most optimal skills to learn for Data Analysts (high demand & high-paying)?
- Identify skills that are both in high demand and associated with high average salaries for Data Analyst roles.
- Focus specifically on remote job postings with specified salary data to ensure accuracy.
- Why? This highlights the most optimal skills—those that provide job security (high demand) and financial benefits (high salaries)—helping job seekers strategically develop the most valuable expertise in data analysis.
*/
...
-- Identify skills associated with high average salaries for Data Analyst roles
-- Use Query #4 
average_salary AS(
    SELECT 
...
-- Retrieve the top 25 skills that are both in high demand and associated with high salaries
SELECT 
